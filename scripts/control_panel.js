// JavaScript Document
let i = 0;   // Dette er slideshowet start punkt, altså den starter fra 0
	let images = [];
	let time = 3000; //dette er tiden mellem billedernes skift, sat i millisekunder (dette er 3 sek)
