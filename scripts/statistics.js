...
//Her laves en ny variable, med mychart etableret i. Den kaldes emballagechart da den indeholder data over emballage
    let emballageChart = new Chart(myChart, {
      ...
      options:{
        ...
        legend:{
          display:true, //Dette er en lille firkant derfor tæller hvad der er på grafen. Den sættes til false. Den ses ikke konstant, da det ikke passer godt til formen
